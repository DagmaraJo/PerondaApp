...
services.AddSingleton<IApp, App>(); // rejestracja
...
var serviceProvider = services.BuildServiceProvider();  //na podstawie prowajdera wyciągamy implementacje naszego interfejsu IApp
var app = serviceProvider.GetService<IApp>()!; //nie będzie nulem! !
/// System.InvalidOperationException: „Unable to resolve service for type 'PerondaApp.Services.IUserCommunication'
/// while attempting to activate 'PerondaApp.Services.App'.”
app.Run();
